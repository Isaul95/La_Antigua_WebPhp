...
<div class="container">
  <div class="row">
    <div class="col-md-12 mt-5">
      ...
      <strong><font color="#D34787">Inventario Platillo</font></strong>
      </h1>
    ...
    <div class="col-md-12">
      ...
      <?php if($permisos->insert == 1):?>
        <div class="d-flex flex-row">
              <a type="button" class="btn btn-primary btn-float" data-toggle="modal" data-target="#modal_add_licenciatura"> <span class="fa fa-plus"></span> Nuevo Platillo</a>
              </div>
      <?php endif;?>
